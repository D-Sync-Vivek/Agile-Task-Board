...
const BoardGuide = () => {
    ...
    return (
        <div className="fixed bottom-4 left-4 p-4 rounded-lg bg-gray-800 opacity-80 hover:opacity-100 transition-opacity text-white text-sm w-64 pointer-events-none select-none z-50">
